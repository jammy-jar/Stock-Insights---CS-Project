...
const projectNextPrice = (currPrice, meanDailyChange, stdDevDailyChange) => {
...
const projectStocks = async (historicalData) => {
  // Simulate 30 projections, using Geometric Brownian Motion for random projections,
  // with a trend.
  const projections = projectPrices(historicalData)
